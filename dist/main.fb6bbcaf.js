...
// Hamburger menu
var hamburgerMenu = document.getElementsByClassName('fa-bars')[0];
var menuModal = document.getElementById('navMenu');
var menuItems = document.getElementsByClassName('nc');
...
var _jump = _interopRequireDefault(require("jump.js/dist/jump.module"));
...
var home = document.getElementById('nav__control-home');
var benefits = document.getElementById('nav__control-benefits');
var wwd = document.getElementById('nav__control-wwd');
var team = document.getElementById('nav__control-team');
var pricing = document.getElementById('nav__control-pricing');
var contact = document.getElementById('nav__control-contact'); // - To Top

home.addEventListener('click', function () {
  (0, _jump.default)('#sub-nav');
}); // - To Benefits

benefits.addEventListener('click', function () {
  (0, _jump.default)('#main__benefits', {
    duration: 1000,
    offset: -150
  });
}); // - To What We Do

wwd.addEventListener('click', function () {
  (0, _jump.default)('#main__WhatWeDo', {
    duration: 1000,
    offset: -50
  });
}); // - To Our Team
...
================================================================
*/
},{"jump.js/dist/jump.module":"node_modules/jump.js/dist/jump.module.js","sal.js":"node_modules/sal.js/dist/sal.js","./events":"js/events.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
